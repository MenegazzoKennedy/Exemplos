      ...
      <a href="#" class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column text-sm" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="{{ route('dashboard.documento.index') }}" class="nav-link {{ request()->routeIs('dashboard.documento.index') ? 'active' : '' }} {{ request()->routeIs('dashboard.documento.edit') ? 'active' : '' }} {{ (request()->is('dashboard.documento.index')) ? 'active' : '' }}">
