        ...
        <div class="row cadastro">
            <div class="col-8">
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control @error('titulo') is-invalid @enderror" placeholder="1" aria-label="Username" aria-describedby="basic-addon1" name="titulo" value="{{ old('titulo') }}" onkeyup ="apresentarSlug()">
                    @error('titulo')
                ...
                <div class="input-group mb-3">
                    ...
                    <select  onselect="manterUnicoSelect()" class="custom-select @error('destaque') is-invalid @enderror" id="inputGroupDestaque1" name="destaque">                  
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control @error('slug') is-invalid @enderror" placeholder="Slug" aria-label="Username" onkeyup="apresentarSlug()" aria-describedby="basic-addon1" name="slug" id="slugUrl" value="{{ old('slug') }}">
                    @error('slug')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control @error('valorProduto') is-invalid @enderror" placeholder="50.000,00" aria-label="Username" aria-describedby="basic-addon1" name="valorProduto" id="valorImovel" value="{{ old('valorProduto') }}">
                    @error('valorProduto')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="input-group mb-3">
                    ...
                    <textarea name="detalhe" placeholder="1" class="form-control @error('detalhe') is-invalid @enderror" value="{{ old('detalhe') }}" style="min-height: 37px;"></textarea>
                    @error('detalhe')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="tell" class="form-control @error('numero') is-invalid @enderror" placeholder="00000-000" aria-label="Username" aria-describedby="basic-addon1" id="cepImovel" name="cep" value="{{ old('cep') }}" onkeyup="editarCep()" maxlength="9">
                    @error('numero')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
...
<script>
    ...
    function editarCep(){
        ...
        $(event.target).val(cep);
    }

    $('#valorImovel').keyup(function(e) {
