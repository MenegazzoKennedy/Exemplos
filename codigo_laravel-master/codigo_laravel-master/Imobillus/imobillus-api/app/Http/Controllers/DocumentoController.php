...
class DocumentoController extends Controller
{
    ...
    {
        $documentos = Negociacao::with(['cliente.user', 'corretor.users', 'imovel', 'documentos'])->paginate(20);
    ...
    {
        //dd($id);
        $documentos = Negociacao::with(['cliente.user', 'corretor.users', 'imovel', 'documentos'])->where('id', $id)->get();
