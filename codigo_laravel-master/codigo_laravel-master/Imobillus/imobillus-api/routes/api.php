...
Route::middleware('auth:api')->group(function() {
    ...
    Route::post('produto/solicitacao', [ProdutoController::class, 'solicitacao']);
    Route::post('preferido/inserir', [UserController::class, 'preferidosInserir']);
    Route::post('preferido/excluir', [UserController::class, 'preferidosExcluir']);
    Route::post('preferido/listar', [UserController::class, 'preferidosListar']);
    Route::post('profile/avatar/update', [UserController::class, 'avatarProfile']);
});

Route::apiResource('imovel', ProdutoController::class);
Route::post('imovel/pesquisa/{filtro}', [ProdutoController::class, 'produtoPesquisa']);
Route::get('imoveis/destaque', [ProdutoController::class, 'produtoDestaque']);
Route::post('imoveis/pesquisas/negociacao', [NegociacaoController::class, 'filtroRicoTeste']);
