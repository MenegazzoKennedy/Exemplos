...
<div class="container-fluid" id="publicacoes-list">
    <div class="row">   
                ...
                <div class="col-12">
                    <div class="back-publi">
                        ...
                        @if($post->post_videos != null)
                            <div class="slider-all">
                                <div class="slider-video slider-video-{{$key}}">
                        ...
                        <div class="btn-funcoes">
                            @if($post->status == 0)
                                <a href="{{ route('dashboard.publicacoes.edit', $post->id) }}" class="btn btn-outline-success">Ativar Post</a>
                            @else
                                <a href="{{ route('dashboard.publicacoes.edit', $post->id) }}" class="btn btn-outline-danger">Desativar Post</a>
                            @endif
                            <a href="{{ route('dashboard.publicacoes.show', $post->id) }}" class="btn btn-outline-info">Ver Mais</a>
                        </div>
                    </div>
                </div>
            @endforeach
        ...
        <div class="col-12 publicacoesLinks">
                {{ $posts->links() }}
            </div>
        </div>
    </div>
...
<style>
    ...
    #publicacoes-list .publicacoesLinks svg{
        max-width:40px;
    }
