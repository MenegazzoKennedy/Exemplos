@extends('layouts.app', ["titulo" => "Onliner Manager Usuários"])
                            ...
                            <th scope="row">{{$user->id }}</th>
                                ...
                                <td>
                                    ...
                                    <div class="box_ctas btn-list text-right">
                                        <form action="{{ route('dashboard.reenvioSenhaUserRota', $user->id) }}" method="POST" class="d-inline">
                                             @csrf
                                            <input name="teste" value="0" class="d-none">
                                            <button type="submit" class="btn waves-effect waves-light btn-rounded btn-outline-info">Reenvio de Senha</button>
                                        </form>
                                        <form action="{{ route('dashboard.usuarios.destroy', $user->id) }}" method="POST"  method="POST" class="d-inline lancamento_form_{{$user->id}}">
                                            @csrf
                                            {{ method_field('DELETE') }}
